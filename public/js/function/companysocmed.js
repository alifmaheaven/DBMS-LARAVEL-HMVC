...
if (Socmedstable.length > 0) {
    ...
    nomorSocmeds += 1
    htmlSocmeds += '<tr><td style="text-align:center;">'+nomorSocmeds+'</td><td style="text-align:center;">'+companySocmedpositionname+'</td><td style="text-align:center;">'+data.socmed_name+'</td><td><button " class="btn btn-primary btn-round" data-array="'+arraySocmeds+'" onclick="deleteSocmedstablerow(this);" >Delete</button></td><td><button class="btn btn-warning btn-round" data-array="'+arraySocmeds+'" onclick="editSocmedstablerow(this);" data-toggle="modal" data-target="#editSocmed" >Edit</button></td></tr>'
